    ...
    <div class="col-sm-12">
      <div class="card">
        ...
        <div style="float:right; margin-right: 1%;">
                            <a href="{{route('invoice.create')}}" class="btn btn-primary" style="color: white;">
          ...
          <table id="example" class="display" style="width:100%">
           ...
           <td>{{$i->created_at}}</td>
                <td> 
                  <div class="row">
                    <div class="col-6">
                    <a href="{{route('invoice.edit',$i->id) }}" class="btn btn-primary" style="color: white;"><i
                                    class="fas fa-edit"></i></a>
                   </div>
                   <div class="col-6">

                          <form method="POST" action="{{ route('invoice.delete',$i->id) }}">
                            @csrf
