    ...
    <div class="col-sm-12">
      <div class="card">
        ...
        <div style="float:right; margin-right: 1%;">
                            <a href="{{route('bank.create')}}" class="btn btn-primary" style="color: white;">
          ...
          <table id="example" class="display" style="width:100%">
            ...
            <tbody>
             ...
             <tr>
                ...
                <td>{{$bank->iban}}</td>
                <td>{{$bank->beneficiary_address}}</td>
                <td>{{$bank->created_at}}</td>
                <td> 
                  <div class="row">
                    <div class="col-6">
                    <a href="{{route('bank.edit',$bank->id) }}" class="btn btn-primary" style="color: white;"><i class="fas fa-edit"></i></a>
                     </div>
                     <div class="col-6">

                     <form method="POST" action="{{ route('bank.delete',$bank->id) }}">
                            @csrf
