    ...
    <div class="col-sm-12">
      <div class="card">
        ...
        <div style="float:right; margin-right: 1%;">
                            <a href="{{route('country.create')}}" class="btn btn-primary" style="color: white;">
            ...
            <tbody>
             ...
             <tr>
              ...
              <td> 
                  <div class="row">
                    <div class="col-6">
                    <a href="{{route('country.edit',$c->id) }}" class="btn btn-primary" style="color: white;"><i
                                    class="fas fa-edit"></i></a>
                   </div>
                   <div class="col-6">

                          <form method="POST" action="{{ route('country.delete',$c->id) }}">
                            @csrf
